...
@Component({
  ...
  imports: [RouterLinkActive, RouterModule, TableListYear, TableListMovieComponent, TableProducersComponent, TableTopWinComponent, CommonModule, AppRoutingModule,  MatListModule, MatButtonModule, MatCardModule, MatGridListModule, MatIconModule, MatSidenavModule, MatToolbarModule]
})
